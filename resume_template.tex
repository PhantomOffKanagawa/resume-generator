...
{% if project.title == "Resume Generator" and project.link and version %}
    \textit{\underline{\href{ {{project.link}}}{ {{project.title}}}}}: {{ project.description }}  This resume is version "{{version}}" generated from the same repository.
{% elif project.link %}
    \textit{\underline{\href{ {{project.link}}}{ {{project.title}}}}}: {{ project.description }}
